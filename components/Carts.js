...
import { minus, changeCheck, checkAll,remove} from '../actions/index';
...
export default connect(mapStateToProps, { minus, changeCheck, checkAll, remove })(Carts)
